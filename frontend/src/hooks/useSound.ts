...
export const useSound = create<State>((set, get) => {
    const initialSrc = JSON.parse(
        localStorage.getItem("playlist") ?? JSON.stringify(shuffleArray(projectDrasilPlaylist))
    );
...
function getTitle(song: string) {
    switch (getFileName(song)) {
        case getFileName(avant):
            return "Avant";
        case getFileName(brave_heart):
            return "Brave Heart";
        case getFileName(break_up):
            return "Break up!";
        case getFileName(butterfly):
            return "Butterfly";
        case getFileName(survive_main_theme):
            return "Survive Main Theme";
        case getFileName(file_city_night):
            return "File City Night";
        case getFileName(evo):
            return "EVO";
        case getFileName(fire):
            return "Fire!!";
        case getFileName(namida_no_yukue):
            return "Namida No Yukue";
        case getFileName(shouri_zen_no_theme):
            return "Shouri (Zen No Theme)";
        case getFileName(target):
            return "Target";
        case getFileName(the_biggest_dreamer):
            return "The Biggest Dreamer";
        case getFileName(bgm_1):
            return "BGM 1";
        case getFileName(bgm_2):
            return "BGM 2";
        case getFileName(bgm_3):
            return "BGM 3";
        case getFileName(bgm_4):
            return "BGM 4";
        case getFileName(bgm_5):
            return "BGM 5";
        case getFileName(bgm_6):
            return "BGM 6";
        case getFileName(bgm_7):
            return "BGM 7";
        case getFileName(bgm_8):
            return "BGM 8";
        case getFileName(bgm_9):
            return "BGM 9";
        case getFileName(bgm_10):
            return "BGM 10";
        case getFileName(bgm_11):
            return "BGM 11";
        case getFileName(bgm_12):
            return "BGM 12";
        case getFileName(bgm_13):
            return "BGM 13";
        case getFileName(bgm_14):
            return "BGM 14";
        case getFileName(bgm_15):
            return "BGM 15";
        case getFileName(bgm_16):
            return "BGM 16";
        case getFileName(bgm_17):
            return "BGM 17";
        case getFileName(bgm_18):
            return "BGM 18";
        case getFileName(bgm_19):
            return "BGM 19";
        case getFileName(bgm_20):
            return "BGM 20";
        default:
            return "";
    }
...
const getFileName = (url: string) => decodeURIComponent(url.substring(url.lastIndexOf("/") + 1));
