...
export const sleeves: Picture[] = [
    ...
    {name: "Default Blue", imagePath: defaultBlue, artist: "Bandai"},
    {name: "Default Green", imagePath: defaultGreen, artist: "Bandai"},
    {name: "Default Yellow", imagePath: defaultYellow, artist: "Bandai"},
    {name: "Default Purple", imagePath: defaultPurple, artist: "Bandai"},
