...
export default function RecoveryPage() {
    ...
    function passwordColor() {
        if (newPassword === "") return "ghostwhite";
        if (regex.test(newPassword)) return "#6ed298";
        else return "#e17b88";
    }

    function repeatedPasswordColor() {
        if (newPasswordRepeated === "") return "ghostwhite";
        if (newPasswordRepeated === newPassword) return "#6ed298";
        else return "#e17b88";
    }
        ...
        <MenuBackgroundWrapper>
            ...
            <StyledForm onSubmit={handleUserSearch}>
                <InputField
                    ...
                    type="text"
                    name="username"
                    placeholder={usernameForRecovery || "username"}
                    maxLength={16}
                />
                <ButtonContainer>
