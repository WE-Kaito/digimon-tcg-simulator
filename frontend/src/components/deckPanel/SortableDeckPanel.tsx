import DeckPanel, { ProfileDeckProps } from "./DeckPanel.tsx";
import { useSortable } from "@dnd-kit/sortable";
import styled from "@emotion/styled";
import { CSS as DNDCSS, Transform } from "@dnd-kit/utilities";

export default function SortableDeckPanel(props: Omit<ProfileDeckProps, "isDragging">) {
    const { attributes, listeners, setNodeRef, transform, transition, isDragging } = useSortable({ id: props.deck.id });
    ...
    return (
        <SortableItemContainer
            ...
            transform={transform}
        >
            <HandleDiv {...listeners} isDragging={isDragging}>
                :::
            </HandleDiv>
            <DeckPanel isDragging={isDragging} {...props} />
        </SortableItemContainer>
    );
}
