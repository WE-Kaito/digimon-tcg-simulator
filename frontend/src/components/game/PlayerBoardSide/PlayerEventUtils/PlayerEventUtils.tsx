        ...
        <Container ref={fontContainerRef} hasChildren={hasChildren}>
            {isOpponentOnline && <>
                {bootStage === BootStage.SHOW_STARTING_PLAYER &&
                    <Lottie animationData={firstAnimation} style={{ transform: "translateY(-20%)"}} autoplay={isFirst} initialSegment={[0, 70]} loop={false}/>
                }
...
const Container = styled.div<{ hasChildren: boolean }>`
  ...
  align-items: center;
  border-radius: 5px;
  background: linear-gradient(20deg, rgba(54, 93, 131, 0.32) 0%, rgba(48, 78, 112, 0.32) 70%, rgba(24, 46, 61, 0.32) 100%);
