    ...
    return (
        <LayoutContainer>
            {wsUtils && <>
                ...
                <StyledIconButton onClick={() => setSurrenderModal(true)} sx={{color: "blanchedalmond", gridArea: "surrender"}}>
                    <SurrenderIcon sx={{fontSize: iconWidth}}/>
                </StyledIconButton>
                <StyledIconButton onClick={() => setRestartRequestModal(true)} sx={{color: "mediumaquamarine", gridArea: "restart"}}>
