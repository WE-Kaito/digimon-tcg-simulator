...
class DeckTest {
    ...
    private static Stream<Arguments> provideDecksForEqualityTest() {
        ...
        Deck deck1 = new Deck("1", "New Deck", new Card[]{card1, card2}, "authorId1");
        Deck deck2 = new Deck("1", "New Deck", new Card[]{card1, card2}, "authorId1");
        Deck deck3 = new Deck("2", "Another Deck", new Card[]{card1, card2}, "authorId2");
        Deck deck4 = new Deck("1", "New Deck", new Card[]{card1}, "authorId1");
