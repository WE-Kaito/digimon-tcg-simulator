...
//        GameRoom gameRoom = new GameRoom(gameId, player1, new ArrayList<>(), player2, new ArrayList<>(), eventPublisher);
...
//    @BeforeEach
//    void setUp() {
//        gameService = new GameService(mongoUserDetailsService, deckService, eventPublisher);
...
//        // GIVEN
//        TextMessage expectedMessage = new TextMessage("[CHAT_MESSAGE]:test test");
//        TextMessage chatMessage = new TextMessage(gameId + ":/chatMessage:test test");
//        putPlayersToGameRoom();
//        // WHEN
