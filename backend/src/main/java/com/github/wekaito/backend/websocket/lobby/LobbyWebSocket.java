        ...
        if (principal != null) {
            ...
            if (playerRoom != null) {
                ...
                synchronized (playerRoom) {
                    ...
                    if (hostDisconnected && !playerRoom.getPlayers().isEmpty()) {
                        LobbyPlayer nextHost = playerRoom.getPlayers().get(0);
                        playerRoom.setHostName(nextHost.getName());
